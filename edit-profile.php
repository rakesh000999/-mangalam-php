...
<div class="row container-lg">
    <div class="col-lg-5 col-md-4">
        <img src="https://avatars.githubusercontent.com/u/154825017?v=4" alt="profile-image" class="">
    </div>
    ...
    <div class="col-lg-7">
        <form action="#" method="post">
            ...
            <div class="form-group">
                ...
                <textarea id="" name="bio" class="form-control" rows="10"><?php if (!empty($userInfo)) echo $userInfo['bio']; ?></textarea>
                <span class="error"><?php echo isset($errors['bio']) ? $errors['bio'] : ''; ?></span>
            </div>
            <div class="form-group">
                <label for="gender" class="h4 w-100">Gender</label>
                <input type="radio" id="male" value="m" name="gender" class="" <?php if (!empty($userInfo)) if ($userInfo['gender'] == "m") echo "checked" ?>>
                <label for="male">Male</label>
                <input type="radio" id="female" value="f" name="gender" class="" <?php if (!empty($userInfo)) if ($userInfo['gender'] == "f") echo "checked" ?>>
                <label for="female">Female</label>
                <input type="radio" id="other" value="o" name="gender" class="" <?php if (!empty($userInfo)) if ($userInfo['gender'] == "o") echo "checked" ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="address" value="<?php if (!empty($userInfo)) echo $userInfo['location']; ?>">
                <span class="error"><?php echo isset($errors['address']) ? $errors['address'] : ''; ?></span>
            </div>
            <div class="my-2">
                <input type="submit" name="update" value="Save" class="bg-primary border-0 text-white px-2 py-1 rounded">
            </div>
        </form>
    </div>
</div>